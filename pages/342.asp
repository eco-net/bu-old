...
<head>
<!--#include virtual="/includes/titleprefix.asp" --><title><%=titleprefix&"Nyheder"%></title><!--#include virtual="/includes/head.asp" -->
...
<div id="maincontent">
<h2>Nyheder</h2>
<div id="maincontenttext">Her findes nyheder indenfor området for Bæredygtig Udvikling.</div><!-- maincontenttext -->
</div><!-- maincontent -->
<!-- END MAIN CONTENT -->

...
<head>
<!--#include virtual="/includes/titleprefix.asp" --><title><%=titleprefix&"Danske bøger og publikationer"%></title><!--#include virtual="/includes/head.asp" -->
...
<!-- MAIN CONTENT -->
<div id="maincontent">
<h2>Danske bøger og publikationer</h2>
<div id="maincontenttext">mm</div><!-- maincontenttext -->
</div><!-- maincontent -->
<!-- END MAIN CONTENT -->

...
<head>
<!--#include virtual="/includes/titleprefix.asp" --><title><%=titleprefix&"Generelt om den Nationale Strategi"%></title><!--#include virtual="/includes/head.asp" -->
...
<!-- MAIN CONTENT -->
<div id="maincontent">
<h2>Generelt om den Nationale Strategi</h2>
<div id="maincontenttext">mmmmmmm</div><!-- maincontenttext -->
</div><!-- maincontent -->
<!-- END MAIN CONTENT -->

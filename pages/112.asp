...
<div id="maincontenttext"><P>Initiativer. </P>
<P>Opmuntre og fremme udviklingen af en 10-årig ramme af programmer, som støtter regionale og nationale initiativer med henblik på at accelerere skiftet til bæredygtig produktion og forbrug, herunder at bryde sammenhængen mellem økonomisk vækst og miljøødelæggelse (artikel 15).</P></div><!-- maincontenttext -->
</div><!-- maincontent -->
<!-- END MAIN CONTENT -->

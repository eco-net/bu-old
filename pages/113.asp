...
<P>Stræbe imod at kemikalier inden år 2020 bruges og produceres på en måde, så væsentlige skadelige effekter på sundhed og miljø minimeres. Dette skal ske ved at gøre brug af&nbsp; videnskabeligt baserede risikovurderings- og risikohåndterings-procedurer, der&nbsp;indkluderer&nbsp;forsigtighedsprincippet (artikel 23).</P></div><!-- maincontenttext -->
</div><!-- maincontent -->
<!-- END MAIN CONTENT -->

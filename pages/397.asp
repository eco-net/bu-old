...
<head>
<!--#include virtual="/includes/titleprefix.asp" --><title><%=titleprefix&"Nordiske organisationer"%></title><!--#include virtual="/includes/head.asp" -->
...
<!-- MAIN CONTENT -->
<div id="maincontent">
<h2>Nordiske organisationer</h2>
<div id="maincontenttext">ssss</div><!-- maincontenttext -->
</div><!-- maincontent -->
<!-- END MAIN CONTENT -->

...
<P>Hvor vi vælger at placere boligen, vil have indflydelse på den mængde af ressourcer samt tid, vi kommer til at bruge på at transportere os til og fra arbejde, til indkøb, skole m.m. Dermed har det betydning i forhold til de energiressourcer, vi kommer til at bruge på transport. </P>
...
<P>Hvilke materialer vælger vi i vores bolig. Vælger vi for eksempel trægulve, som er en fornyelig ressource, eller marmorgulve, som er en ikke-fornyelig ressource, der udvindes med relativt store miljømæssige konsekvenser? </P>
<P>Hvordan skal den opvarmes? Som et lavenergihus med opvarmning via solenergi? Eller et hus med stort energiforbrug og oliefyr, der bruger store mængder ikke-fornyelige energiressourcer? </P>
<P>Vores individuelle handlinger i forbindelse med vores valg af bolig har således konsekvenser for bæredygtigheden. Ikke alene på grund af vores egen økonomi, men også for den samfundsmæssige bæredygtighed for vores egen generation og for fremtidige generationer. </P></div><!-- maincontenttext -->
</div><!-- maincontent -->
<!-- END MAIN CONTENT -->

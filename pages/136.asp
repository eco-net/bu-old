...
<head>
<!--#include virtual="/includes/titleprefix.asp" --><title><%=titleprefix&"By- og boligudvikling"%></title><!--#include virtual="/includes/head.asp" -->

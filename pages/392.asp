...
<head>
<!--#include virtual="/includes/titleprefix.asp" --><title><%=titleprefix&"Nordiske bøger og publikationer"%></title><!--#include virtual="/includes/head.asp" -->
...
<!-- MAIN CONTENT -->
<div id="maincontent">
<h2>Nordiske bøger og publikationer</h2>
<div id="maincontenttext">nn</div><!-- maincontenttext -->
</div><!-- maincontent -->
<!-- END MAIN CONTENT -->

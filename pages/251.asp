...
<head>
<!--#include virtual="/includes/titleprefix.asp" --><title><%=titleprefix&"Hvordan Uddannelse for Bæredygtig Uddannelse?"%></title><!--#include virtual="/includes/head.asp" -->
...
<!-- MAIN CONTENT -->
<div id="maincontent">
<h2>Hvordan Uddannelse for Bæredygtig Uddannelse?</h2>
<div id="maincontenttext"><P>Uddannelse for bæredygtig udvikling vil forudsætte en tilgang til undervisningen der er: </P>
<UL>
<LI>Transdiciplinary<BR>Holistisk<BR>Kritisk<BR>Aktion orienteret<BR>Participatorisk<BR>Livslang læring </LI></UL>
<P>Transdiciplinary</P></div><!-- maincontenttext -->
</div><!-- maincontent -->
<!-- END MAIN CONTENT -->

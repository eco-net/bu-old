...
<head>
<!--#include virtual="/includes/titleprefix.asp" --><title><%=titleprefix&"Litteratur"%></title><!--#include virtual="/includes/head.asp" -->
...
<div id="maincontent">
<h2>Litteratur</h2>
<div id="maincontenttext"><P>Du kan her finde henvisninger til bøger og publikationer, der kan give yderligere informationer om Bæredygtig Udvikling. </P>
<P>&nbsp;</P>
<P>Henvisningerne er delt op i følgende kategorier: </P>
<UL>
<LI><STRONG>Danske bøger og publikationer. </STRONG></LI>
<LI><STRONG>Nordiske bøger og publikationer. </STRONG></LI>
<LI><STRONG>Engelsk sproget bøger og publikationer.</STRONG></LI></UL></div><!-- maincontenttext -->
</div><!-- maincontent -->
<!-- END MAIN CONTENT -->

...
<head>
<!--#include virtual="/includes/titleprefix.asp" --><title><%=titleprefix&"Retsligt"%></title><!--#include virtual="/includes/head.asp" -->
<meta name="keywords" content="Retslig tilgang til bæredygtig udvikling" />
<meta name="description" content="bæredygtig, udvikling, retsligt, samfund, retsorden, borgernes, handling, gyldighed, legalt, ulovligt." />
</head>
<body>
...
<P>Det kan også være ulovligt at beherske eller udnytte naturen på måder, som ikke er bæredygtig. Fx at have flere svin i en svinebesætning, end samfundet har fundet er bæredygtigt i forhold til naturens bæreevne. </P></div><!-- maincontenttext -->
</div><!-- maincontent -->
<!-- END MAIN CONTENT -->

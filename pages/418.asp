...
<head>
<!--#include virtual="/includes/titleprefix.asp" --><title><%=titleprefix&"Nyheder Miljøinfo"%></title><!--#include virtual="/includes/head.asp" -->
...
<!-- MAIN CONTENT -->
<div id="maincontent">
<h2>Nyheder Miljøinfo</h2>
<div id="maincontenttext">Her kommer nyheder fra Miljøinfo</div><!-- maincontenttext -->
</div><!-- maincontent -->
<!-- END MAIN CONTENT -->
